    ...
    <main class="main-content md:ml-[288px] min-h-screen transition-all duration-500 p-4 md:p-8 relative z-10">
        ...
        <div class="flex items-center justify-between mb-8 px-2">
            <div class="flex gap-8 border-b border-white/5 relative">
                ...
                <button class="filter-tab font-cinzel text-[10px] pb-2 text-gray-500 tracking-widest hover:text-white transition-colors">ĐANG ĐẤU GIÁ</button>
                <button class="filter-tab font-cinzel text-[10px] pb-2 text-gray-500 tracking-widest hover:text-white transition-colors">KHO TRỐNG</button>
            </div>
            ...
            <div class="hidden md:flex items-center gap-3 bg-white/5 px-4 py-2 rounded-xl border border-white/5">
                <div class="text-right">
                    ...
                    <p class="text-[10px] font-bold text-white">85%</p>
                </div>
